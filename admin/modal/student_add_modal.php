    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header py-2 px-0">
            	<div class="row float-left ml-2"><h4 class="modal-title float-left" id="myModalLabel"><i class="fa-solid fa-plus mr-1"></i>Add New Student</h4></div>
			...
			<form method="POST">
				...
				<div class="row form-group">
					...
					<div class="col-sm-8">
						<input type="number" class="form-control contact-input" name="contact" value="" placeholder="Input contact number" required>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-4">
					...
					<div class="col-sm-8">
						<input type="number" class="form-control contact-input" name="guardian_contact" value="" placeholder="Input guardian's contact" required>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-4">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="edit" class="btn btn-primary" id="addStudent"></i>Save</a>
			</form>
            </div>
